...
- Shorten Cup testing labels and descriptions.
## [1.8.29] - 2026-09-15
### Added
...
- Stored the triggering fixture for new Champions League position changes so graph labels remain accurate.
...
### Fixes
- Fixed the Home Assistant update build failing when release notes contain only fixes.
- Retained the champion trophy improvements from 1.2.7.
